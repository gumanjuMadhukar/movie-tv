...
const Details = () => {
    ...
    const fetchData = async () =>{
        try{
          const {data} = await axios.get(`https://api.themoviedb.org/3/${_media_type}/${id}?api_key=31efb342feaceceeb22902f6a79f0e0d&language=en-US`);
          setContent(data);
            ...
            <Row>
                ...
                <div className='card__content'>
                            <div className="card__wrap">
                                <span className="card__rate">Rating:{vote_average}</span>

                                <ul className="card__list list-unstyled">
                                    <li><span>Language:</span>{original_language}</li>
                                    <li>{adult}</li>
                                </ul>
                            </div>
                            <ul className="card__meta list-unstyled ">
                                <li>
                                    <span>Genre:</span> 
